...
public class Justify {
    ...
    public static void setupScaleSpans(final @NonNull Justified justified,
                                final @NonNull int[] textViewSpanStarts,
                                final @NonNull int[] textViewSpanEnds,
                                final @NonNull ScaleSpan[] textViewSpans) {
...
//      final float w = layout.getLineMax(line);      // Doesn't work well
    ...
    public static class ScaleSpan extends MetricAffectingSpan {
        ...
        @Override
        public void updateMeasureState(final @NonNull TextPaint ds) {
            ds.setTextScaleX(ds.getTextScaleX() * mProportion);
        }
