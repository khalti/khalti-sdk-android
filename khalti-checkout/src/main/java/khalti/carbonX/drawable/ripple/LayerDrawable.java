package khalti.carbonX.drawable.ripple;
 ...
 */
public class LayerDrawable extends khalti.carbonX.drawable.ripple.LollipopDrawable implements Drawable.Callback {
    /**
    ...
    private void inflateLayers(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            if (layer.mDrawable == null && (layer.mThemeAttrs == null ||
                ...
                layer.mDrawable = khalti.carbonX.drawable.ripple.LollipopDrawablesCompat.createFromXmlInner(r, parser, attrs, theme);
            }
    ...
    public void applyTheme(Resources.Theme t) {
       ...
       /* if (state.mThemeAttrs != null) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (d != null && khalti.carbonX.drawable.ripple.LollipopDrawablesCompat.canApplyTheme(d)) {
                khalti.carbonX.drawable.ripple.LollipopDrawablesCompat.applyTheme(d, t);
    ...
    static class ChildDrawable {
        ...
        public boolean canApplyTheme() {
            return mThemeAttrs != null
                    || (mDrawable != null && khalti.carbonX.drawable.ripple.LollipopDrawablesCompat.canApplyTheme(mDrawable));
        }
    }
