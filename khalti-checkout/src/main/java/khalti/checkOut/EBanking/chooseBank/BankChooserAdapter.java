...
public class BankChooserAdapter extends RecyclerView.Adapter<BankChooserAdapter.MyViewHolder> {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(View itemView) {
            ...
            tvBankIcon = (AppCompatTextView) itemView.findViewById(R.id.tvBankIcon);
            tvBankName = (AppCompatTextView) itemView.findViewById(R.id.tvBankName);
            tvBankId = (AppCompatTextView) itemView.findViewById(R.id.tvBankId);
